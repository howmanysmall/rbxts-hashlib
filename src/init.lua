...
local function keccak_feed(lanes_lo, lanes_hi, str, offs, size, block_size_in_bytes)
	...
	for pos = offs, offs + size - 1, block_size_in_bytes do
		...
		for round_idx = 1, 24 do
			...
			L01_lo, L02_lo, L03_lo, L04_lo, L05_lo = bit32_bxor(L01_lo, bit32_band(-1 - L02_lo, L03_lo)), bit32_bxor(
				L02_lo,
				bit32_band(-1 - L03_lo, L04_lo)
			), bit32_bxor(L03_lo, bit32_band(-1 - L04_lo, L05_lo)), bit32_bxor(
				L04_lo,
				bit32_band(-1 - L05_lo, L01_lo)
			), bit32_bxor(L05_lo, bit32_band(-1 - L01_lo, L02_lo))
			L01_hi, L02_hi, L03_hi, L04_hi, L05_hi = bit32_bxor(L01_hi, bit32_band(-1 - L02_hi, L03_hi)), bit32_bxor(
				L02_hi,
				bit32_band(-1 - L03_hi, L04_hi)
			), bit32_bxor(L03_hi, bit32_band(-1 - L04_hi, L05_hi)), bit32_bxor(
				L04_hi,
				bit32_band(-1 - L05_hi, L01_hi)
			), bit32_bxor(L05_hi, bit32_band(-1 - L01_hi, L02_hi))
			L06_lo, L07_lo, L08_lo, L09_lo, L10_lo = bit32_bxor(L09_lo, bit32_band(-1 - L10_lo, L06_lo)), bit32_bxor(
				L10_lo,
				bit32_band(-1 - L06_lo, L07_lo)
			), bit32_bxor(L06_lo, bit32_band(-1 - L07_lo, L08_lo)), bit32_bxor(
				L07_lo,
				bit32_band(-1 - L08_lo, L09_lo)
			), bit32_bxor(L08_lo, bit32_band(-1 - L09_lo, L10_lo))
			L06_hi, L07_hi, L08_hi, L09_hi, L10_hi = bit32_bxor(L09_hi, bit32_band(-1 - L10_hi, L06_hi)), bit32_bxor(
				L10_hi,
				bit32_band(-1 - L06_hi, L07_hi)
			), bit32_bxor(L06_hi, bit32_band(-1 - L07_hi, L08_hi)), bit32_bxor(
				L07_hi,
				bit32_band(-1 - L08_hi, L09_hi)
			), bit32_bxor(L08_hi, bit32_band(-1 - L09_hi, L10_hi))
			L11_lo, L12_lo, L13_lo, L14_lo, L15_lo = bit32_bxor(L12_lo, bit32_band(-1 - L13_lo, L14_lo)), bit32_bxor(
				L13_lo,
				bit32_band(-1 - L14_lo, L15_lo)
			), bit32_bxor(L14_lo, bit32_band(-1 - L15_lo, L11_lo)), bit32_bxor(
				L15_lo,
				bit32_band(-1 - L11_lo, L12_lo)
			), bit32_bxor(L11_lo, bit32_band(-1 - L12_lo, L13_lo))
			L11_hi, L12_hi, L13_hi, L14_hi, L15_hi = bit32_bxor(L12_hi, bit32_band(-1 - L13_hi, L14_hi)), bit32_bxor(
				L13_hi,
				bit32_band(-1 - L14_hi, L15_hi)
			), bit32_bxor(L14_hi, bit32_band(-1 - L15_hi, L11_hi)), bit32_bxor(
				L15_hi,
				bit32_band(-1 - L11_hi, L12_hi)
			), bit32_bxor(L11_hi, bit32_band(-1 - L12_hi, L13_hi))
			L16_lo, L17_lo, L18_lo, L19_lo, L20_lo = bit32_bxor(L20_lo, bit32_band(-1 - L16_lo, L17_lo)), bit32_bxor(
				L16_lo,
				bit32_band(-1 - L17_lo, L18_lo)
			), bit32_bxor(L17_lo, bit32_band(-1 - L18_lo, L19_lo)), bit32_bxor(
				L18_lo,
				bit32_band(-1 - L19_lo, L20_lo)
			), bit32_bxor(L19_lo, bit32_band(-1 - L20_lo, L16_lo))
			L16_hi, L17_hi, L18_hi, L19_hi, L20_hi = bit32_bxor(L20_hi, bit32_band(-1 - L16_hi, L17_hi)), bit32_bxor(
				L16_hi,
				bit32_band(-1 - L17_hi, L18_hi)
			), bit32_bxor(L17_hi, bit32_band(-1 - L18_hi, L19_hi)), bit32_bxor(
				L18_hi,
				bit32_band(-1 - L19_hi, L20_hi)
			), bit32_bxor(L19_hi, bit32_band(-1 - L20_hi, L16_hi))
			L21_lo, L22_lo, L23_lo, L24_lo, L25_lo = bit32_bxor(L23_lo, bit32_band(-1 - L24_lo, L25_lo)), bit32_bxor(
				L24_lo,
				bit32_band(-1 - L25_lo, L21_lo)
			), bit32_bxor(L25_lo, bit32_band(-1 - L21_lo, L22_lo)), bit32_bxor(
				L21_lo,
				bit32_band(-1 - L22_lo, L23_lo)
			), bit32_bxor(L22_lo, bit32_band(-1 - L23_lo, L24_lo))
			L21_hi, L22_hi, L23_hi, L24_hi, L25_hi = bit32_bxor(L23_hi, bit32_band(-1 - L24_hi, L25_hi)), bit32_bxor(
				L24_hi,
				bit32_band(-1 - L25_hi, L21_hi)
			), bit32_bxor(L25_hi, bit32_band(-1 - L21_hi, L22_hi)), bit32_bxor(
				L21_hi,
				bit32_band(-1 - L22_hi, L23_hi)
...
for width = 224, 256, 32 do
	local H_lo, H_hi = table.create(8), table.create(8)
	for j = 1, 8 do
...
local function sha256ext(width, message)
	...
	local length, tail = 0, ""
	local H = table.move(Array256, 1, 8, 1, table.create(8))
...
local function sha512ext(width, message)
	...
	local length, tail, H_lo, H_hi =
		0, "", table.pack(table.unpack(sha2_H_ext512_lo[width])), table.pack(table.unpack(sha2_H_ext512_hi[width]))
...
local function md5(message: string): string
	-- Create an instance (private objects for current calculation)
	local H, length, tail = table.move(md5_sha1_H, 1, 4, 1, table.create(4)), 0, ""
	...
	local function partial(message_part)
		if message_part then
			...
			if tail then
				...
				tail ..= (#tail + 1 == block_size_in_bytes and string.char(gap_start + 128) or string.char(gap_start) .. string.rep(
					"\0",
				...
				local function get_next_part_of_digest(bytes_needed)
					...
					if bytes_needed <= last_part_size then
						...
						local result2 = string.sub(last_part, 1, part_size_in_nibbles)
...
local function hex2bin(hex_string: string): string
...
local function bin2base64(binary_string: string): string
...
local function base642bin(base64_string: string): string
	...
	for pos, ch in string.gmatch(string.gsub(base64_string, "%s+", ""), "()(.)") do
		...
		if idx > 0 then
			...
			length += 1
			result[length] = string.sub(string.char(c1, c2, c3), 1, chars_qty)
		end
	end
...
local function hmac(hash_func: (key: string) -> string, key: string, message: string?, AsBinary: boolean?)
	-- Create an instance (private objects for current calculation)
	...
	local append = hash_func()(string.gsub(key, ".", function(c)
		return string.char(bit32_bxor(string.byte(c) :: number, 0x36))
...
local sha = {
	...
	shake128 = function(message: string, digest_size_in_bytes: number): string
		return keccak(168, digest_size_in_bytes, true, message)
	end;

	shake256 = function(message: string, digest_size_in_bytes: number): string
